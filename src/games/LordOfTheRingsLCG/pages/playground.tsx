...
import { LogContainer, LogButton, PlayerDeck, GameArea, PlayerDeckCountText } from './playgroundStyles'
...
const Playground = (): ReactElement => {
    ...
    const [ gameState, setGameState ] = useState({
        ...
        adventureDeck: Helpers.prepareAdventureDeck(Dealer.AdventureCards, game.preGameSettings.adventure)
    })
    ...
    return (
        <>
            <Prompt when={true} message="Вы уверены что хотите прервать игру и закрыть страницу?" />
            ...
            <GameArea>
                <PlayerDeck>
                    <PlayerDeckCountText theme={settings.theme}>{gameState.playerDeck?.length}</PlayerDeckCountText>
                </PlayerDeck>
            </GameArea>
